...
<div class="breadcrub-container">
    <ul class="breadcrumb">
        ...
        <li><a>{{ Route::currentRouteNamed('heat_output_ranges_add') ? 'Add' : 'Edit' }} Heat Output Ranges</a></li>
    </ul>
</div>
...
<div class="inner-container" style="max-width: 400px;">
    ...
    <div class="form-container">
        ...
        @endif
        <form class="form-horizontal" role="form" method="POST" action="{{ Route::currentRouteNamed('heat_output_ranges_add') ? '/heatOutputRanges/add' : '/heatOutputRanges/edit' }}" autocomplete="off">
            ...
            <div class="form-group" style="text-align:right">
                <div class="">
                    ...
                    <a href="/heatOutputRanges" class="action-btn btn-cancel"> Cancel  </a>
                </div>
            </div>
        </form>
    </div>
