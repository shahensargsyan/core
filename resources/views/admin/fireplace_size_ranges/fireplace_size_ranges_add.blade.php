...
<div class="breadcrub-container">
    <ul class="breadcrumb">
        ...
        <li><a>{{ Route::currentRouteNamed('fireplace_size_ranges_add') ? 'Add' : 'Edit' }} Fireplace Size Ranges</a></li>
    </ul>
</div>
...
<div class="inner-container" style="max-width: 400px;">
    ...
    <div class="form-container">
        ...
        @endif
        <form class="form-horizontal" role="form" method="POST" action="{{ Route::currentRouteNamed('fireplace_size_ranges_add') ? '/fireplaceSizeRanges/add' : '/fireplaceSizeRanges/edit' }}" autocomplete="off">
            ...
            <div class="form-group" style="text-align:right">
                <div class="">
                    ...
                    <a href="/fireplaceSizeRanges" class="action-btn btn-cancel"> Cancel  </a>
                </div>
            </div>
        </form>
    </div>
