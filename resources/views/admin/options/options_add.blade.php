...
<div class="breadcrub-container">
    <ul class="breadcrumb">
        ...
        <li><a>{{ Route::currentRouteNamed('options_add') ? 'Add' : 'Edit' }} Option</a></li>
    </ul>
</div>
...
<div class="inner-container" style="max-width: 400px;">
    ...
    <div class="form-container">
        ...
        @endif
        <form class="form-horizontal" role="form" method="POST" action="{{ Route::currentRouteNamed('options_add') ? '/options/add' : '/options/edit' }}/{{$product_id}}" autocomplete="off">
                    ...
                    <div data-provides="fileinput" class="fileinput fileinput-new">
                            <div class="slim" style=";min-height:100px;min-width: 100px;"
                                    ...
                                    @if(isset($data) && $data->image)
                                        <img src="/images/options_and_accessory/{{ $data->image }}?{{ time() }}" alt=""/>
                                    @endif
            ...
            <div class="form-group" style="text-align:right">
                <div class="">
                    ...
                    <a href="/options" class="action-btn btn-cancel"> Cancel  </a>
                </div>
            </div>
        </form>
    </div>
