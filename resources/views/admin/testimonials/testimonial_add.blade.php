...
<div class="breadcrub-container">
    <ul class="breadcrumb">
        ...
        <li><a>{{ Route::currentRouteNamed('testimonials_add') ? 'Add' : 'Edit' }} Tsetimonial</a></li>
    </ul>
</div>
...
<div class="inner-container" style="max-width: 400px;">
    ...
    <div class="form-container">
        ...
        @endif
        <form class="form-horizontal" role="form" method="POST" action="{{ Route::currentRouteNamed('testimonials_add') ? '/testimonials/add' : '/testimonials/edit' }}" autocomplete="off">
                    ...
                    <div data-provides="fileinput" class="fileinput fileinput-new">
                            <div class="slim" style=";min-height:100px;min-width: 100px;"
                                    ...
                                    @if(isset($data) && $data->image)
                                        <img src="/images/testimonials/{{ $data->image }}?{{ time() }}" alt=""/>
                                    @endif
            ...
            <div class="form-group" style="text-align:right">
                <div class="">
                    ...
                    <a href="/testimonials" class="action-btn btn-cancel"> Cancel  </a>
                </div>
            </div>
        </form>
    </div>
