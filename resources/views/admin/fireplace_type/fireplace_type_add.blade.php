...
<div class="breadcrub-container">
    <ul class="breadcrumb">
        ...
        <li><a>{{ Route::currentRouteNamed('fireplace_types_add') ? 'Add' : 'Edit' }} Fireplace type</a></li>
    </ul>
</div>
...
<div class="inner-container" style="max-width: 400px;">
    ...
    <div class="form-container">
        ...
        @endif
        <form class="form-horizontal" role="form" method="POST" action="{{ Route::currentRouteNamed('fireplace_types_add') ? '/fireplace_types/add' : '/fireplace_types/edit' }}" autocomplete="off">
                    ...
                    <div data-provides="fileinput" class="fileinput fileinput-new">
                            <div class="slim" style=";min-height:100px;min-width: 100px;"
                                    ...
                                    @if(isset($data) && $data->image)
                                        <img src="/images/fireplace_types/{{ $data->image }}?{{ time() }}" alt=""/>
                                    @endif
            ...
            <div class="form-group" style="text-align:right">
                <div class="">
                    ...
                    <a href="/fireplace_types" class="action-btn btn-cancel"> Cancel  </a>
                </div>
            </div>
        </form>
    </div>
